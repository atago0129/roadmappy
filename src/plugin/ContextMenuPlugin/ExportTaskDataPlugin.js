    ...
    return [
        {
          ...
          onClick: () => {
              ...
              document.body.appendChild(dummy);
              dummy.setAttribute('id', 'copy-dummy');
              document.getElementById('copy-dummy').value = JSON.stringify(this.roadmappy.roadmap.toAssoc()).tasks;
              dummy.select();
              document.execCommand('copy');
              document.body.removeChild(dummy);
          },
        ...
        },
        {
            ...
            onClick: () => {
                const blob = new Blob([JSON.stringify(this.roadmappy.roadmap.toAssoc()).tasks], {type: 'application\/json'});
